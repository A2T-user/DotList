...
sealed interface Response {
    data class Success(val fileName: String, val uri: Uri, val mediaFileType: MediaFileType): Response
    data class FileFromExternalAppStorage(val fileName: String): Response
